						...
						<div class="row">					
							<div class="text-center" id="bordas">	
								<form name="formulario" method="POST" action="">
									<h1><meta http-equiv="refresh" content=url="index.php">Apagar Feedrie</h1>
                                                                        <br>
									<div class="conteudo">
										<div class="info">
										<?php
											...
											{
										?>
											<h4 class="text-danger">Escolha o Feedrie que deseja Excluir</h4>
										<?php
												$verifica = "";
												...
												{
													$verifica = false;
													echo "Não há registros de máquinas, Clique aqui para registrar: <a href='CadastraFeedrie.php'>Registrar</a>";
												}
										?>
											<br><br><input type="submit" name="enviar" value="Excluir" class="btn btn-success btn btn-lg">
										<?php												
												if(isset($_POST["enviar"]))
                                                {
													if($verifica === true)
													{
														...
														$sql = "delete from feedrie where cod_feedrie=".$IndexCBX;
														if ($conn->query($sql) === TRUE) 
														{
															echo "Record deleted successfully";
															ECHO "<script type='text/javascript'>alert('Dados deletados com sucesso!');<script/>";
															header('location: Exibe.php');
														}
														else 
														{
