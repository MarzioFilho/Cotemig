							...
							<div class="col-sm-12 text-center">	
								<form name="formulario" method="POST" action="">
									...
									<div id="bordas">
										<div class="info">
											<label>Nome:</label>
											<input type="text" name="nome" value="" class="lead form-control" required>
											<br>
											<label>Número de série:</label>
											<input type="number"  name="numero_serie" value="" class="lead form-control" required>
											<br>
											...
											<?php
												...
												if(isset($_POST["enviar"]))
												{
													...
													$sql = "insert into feedrie values(null,'".$nome."',".$num_serie.",".$cod_usuario.")";
